...
const dao = {
  ...
  selectList(params: SettingSelectListParams): Promise<SelectedListResult<SettingAttribute>> {
  ...
  selectInfo(params: SettingSelectInfoParams): Promise<SettingAttribute | null> {
    return new Promise((resolve, reject) => {
