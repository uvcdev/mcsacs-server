...
//         id: Number(req.params.id),
//         facilityGroupGroupId: req.body.facilityGroupGroupId,
...
//       // 입력값 체크
//       if (!(typeof params.facilityGroupGroupId === 'number' && params.facilityGroupGroupId > 0)
//         || !(typeof params.zoneId === 'number' && params.zoneId > 0)
//         || !params.code
//         || !params.name) {
//         const err = new ErrorClass(resCode.BAD_REQUEST_NOTNULL, 'Not allowed null (facilityGroupGroupId, zoneId, code, name)');
